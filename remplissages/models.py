...
class Evangelisation(models.Model): 
    ...
    boss = models.ManyToManyField(User, related_name='participations', blank=True, verbose_name="Qui sont présents ?")
...
class Person(models.Model):
    ...
    boss = models.ManyToManyField(User, related_name='personnes', 
